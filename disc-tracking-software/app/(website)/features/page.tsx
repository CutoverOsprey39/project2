      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-8 md:py-12">
        <div className="items-center">
          ...
          <div className="space-y-6 text-lg md:text-xl leading-relaxed">
            <p>
              Our software and disc tracking device offers a range of features designed to help disc golf players improve their game. From advanced tracking and analysis to personalized insights, <b>we've got you covered.</b>
            </p>
            
            <p>
              We accomplish this via GPS/GNSS satellite telemetry data, accelerometer modules, and LoRa/BLE PNY long range protocols for offline use in tandem with your mobile device. We first triangulate your position on the course, then track the flight path of your disc, and interpret the data to provide you with actionable insights.
            </p>
